...
publishing {
    ...
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/Lyttle-Development/LyttleDisguise")
            credentials {
...
modrinth {
    ...
    projectId.set("lyttledisguise") // Replace with your Modrinth project slug or ID
